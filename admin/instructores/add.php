...
if($res->num_rows > 0) { // Si la consulta dió algún registro significa que ya existe y entra en el if
  ...
  $passEncrytp = password_hash($params->password, PASSWORD_DEFAULT); // Escriptamos la contraseña
  ...
  VALUES (NULL, '".$params->nombre."', '".$params->apellidos."', '".$params->email."', '".$passEncrytp."', '".$params->telefono."', '".$params->tituloAcademico."');");
