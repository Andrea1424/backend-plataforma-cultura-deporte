<?php
  ...
  $delete = mysqli_query($conexion,"DELETE FROM `actividades_usuarios` WHERE `actividades_usuarios`.`idActividadUsuario`= '".$_GET['idActividadUsuario']."'"); // Se obtiene de la peticion GET en la URL
